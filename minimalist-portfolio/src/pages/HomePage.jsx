  ...
  return (
    <section>
      ...
      <div className='sm:relative container mx-auto px-5 md:px-0'>
        ...
        <div className=''>
          <picture>
            <source media='(min-width: 1024px)' srcSet={new URL(homePageHero, import.meta.url).href} />
            <source media='(min-width: 768px)' srcSet={new URL(homePageHeroT, import.meta.url).href} />
            <img src={new URL(homePageHeroM, import.meta.url).href} alt={'hero pic'} className='w-full sm:h-[600px] object-cover' />
          </picture>
        </div>
      ...
      <div className='flex flex-col sm:flex-row gap-8 sm:gap-16 lg:gap-32 container mx-auto mt-32 sm:h-[600px] px-5 md:px-0'>
        ...
        <picture>
          <source media='(min-width: 1024px)' srcSet={new URL(homePageProfile, import.meta.url).href} />
          <source media='(min-width: 768px)' srcSet={new URL(homePageProfileT, import.meta.url).href} />
          <img src={new URL(homePageProfileM, import.meta.url).href} alt={'hero pic'} className='h-full' />
        </picture>
