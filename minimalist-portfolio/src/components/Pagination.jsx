...
export default function Pagination({ allProjects, currentProjectId }) {
    ...
    return (
        <div className="flex border-t-2 border-b-2 border-cusLightGrey h-[132px] mt-24">
            ...
            <NavLink 
                className="w-1/2 border-r-2 border-cusLightGrey flex group transition-all duration-300 hover:bg-gray-50"
            ...
            <NavLink 
                className="w-1/2 flex group transition-all duration-300 hover:bg-gray-50" 
